...
class Ui_metadata_panel(object):
    def setupUi(self, metadata_panel):
        ...
        self.artist_text = QtWidgets.QLineEdit(self.frame_12)
        self.artist_text.setObjectName("artist_text")
        self.horizontalLayout_4.addWidget(self.artist_text)
        self.artist_submit = QtWidgets.QPushButton(self.frame_12)
        self.artist_submit.setObjectName("artist_submit")
        self.horizontalLayout_4.addWidget(self.artist_submit)
        self.verticalLayout_8.addWidget(self.frame_12)
        self.artist_list = QtWidgets.QListView(self.frame_11)
    ...
    def retranslateUi(self, metadata_panel):
        ...
        self.artist_submit.setText(_translate("metadata_panel", "Create"))
