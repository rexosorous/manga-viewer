...
class Ui_search_panel(object):
    def setupUi(self, search_panel):
        ...
        self.no_characters_button = QtWidgets.QPushButton(self.frame_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.no_characters_button.sizePolicy().hasHeightForWidth())
        self.no_characters_button.setSizePolicy(sizePolicy)
        self.no_characters_button.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.no_characters_button.setObjectName("no_characters_button")
        self.horizontalLayout_6.addWidget(self.no_characters_button)
        self.verticalLayout_5.addWidget(self.frame_8)
        self.characters_scroll_area = QtWidgets.QScrollArea(self.frame_6)
        self.characters_scroll_area.setWidgetResizable(True)
        self.characters_scroll_area.setObjectName("characters_scroll_area")
        self.characters_scroll_layout = QtWidgets.QWidget()
        self.characters_scroll_layout.setGeometry(QtCore.QRect(0, 0, 365, 667))
        self.characters_scroll_layout.setObjectName("characters_scroll_layout")
        self.characters_scroll_area.setWidget(self.characters_scroll_layout)
        self.verticalLayout_5.addWidget(self.characters_scroll_area)
        ...
        self.traits_text = QtWidgets.QLineEdit(self.frame_22)
        self.traits_text.setObjectName("traits_text")
        self.verticalLayout_7.addWidget(self.traits_text)
        self.traits_list = QtWidgets.QListWidget(self.frame_22)
        self.traits_list.setObjectName("traits_list")
        self.verticalLayout_7.addWidget(self.traits_list)
    ...
    def retranslateUi(self, search_panel):
        ...
        self.label_5.setText(_translate("search_panel", "Characters"))
        self.no_characters_button.setText(_translate("search_panel", "No Characters"))
        self.label_6.setText(_translate("search_panel", "Character Traits"))
