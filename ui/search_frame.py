...
class Ui_search_panel(object):
    def setupUi(self, search_panel):
        ...
        self.widget.setGeometry(QtCore.QRect(0, 0, 365, 667))
        self.widget.setObjectName("widget")
        self.characters_scroll_layout = QtWidgets.QVBoxLayout(self.widget)
        self.characters_scroll_layout.setObjectName("characters_scroll_layout")
        self.characters_scroll_area.setWidget(self.widget)
